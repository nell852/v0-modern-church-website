    ...
    <footer className="bg-muted/50 border-t">
      <div className="container px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-3">
              <div className="flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-primary text-primary-foreground">
                <Cross className="h-4 w-4 sm:h-6 sm:w-6" />
              </div>
              <div className="flex flex-col">
                <span className="text-base sm:text-lg font-semibold">Paroisse Saint-Esprit</span>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-muted-foreground">01 23 45 67 89</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-4 w-4 text-primary flex-shrink-0" />
                <span className="text-sm text-muted-foreground break-all sm:break-normal">
                  contact@paroisse-saint-esprit.fr
                </span>
              </div>
              <div className="flex items-start space-x-3">
          ...
          {/* Newsletter */}
          <div className="space-y-3 sm:space-y-4 sm:col-span-2 lg:col-span-1">
            <h3 className="font-semibold text-sm sm:text-base">Newsletter</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Recevez nos actualités et événements directement dans votre boîte mail.
            </p>
            <div className="space-y-2">
              <Input placeholder="Votre adresse email" type="email" className="text-sm" />
              <Button className="w-full bg-primary hover:bg-primary/90 text-sm">S'abonner</Button>
            </div>
        ...
        <div className="border-t mt-6 sm:mt-8 pt-6 sm:pt-8 text-center">
          <p className="text-xs sm:text-sm text-muted-foreground px-4 sm:px-0">
            © 2024 Paroisse Saint-Esprit. Tous droits réservés. Site créé avec ❤️ pour notre communauté.
          </p>
        </div>
      </div>
    </footer>
