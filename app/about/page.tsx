            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Fondée en 1892, la Paroisse Saint-Esprit a traversé les époques en gardant intact son engagement au
                    service de la communauté. Née de la volonté de quelques familles pieuses du quartier, notre église a
                    grandi avec la ville, accueillant des générations de fidèles.
                  </p>
                  <p>
                    Au fil des décennies, nous avons su nous adapter aux besoins de notre temps tout en préservant la
                    richesse de la tradition catholique. Notre église, reconstruite en 1954 après les dommages de la
                    guerre, témoigne de la résilience et de la foi de notre communauté.
                  </p>
                  <p>
                    Aujourd'hui, nous continuons cette mission d'accueil et d'accompagnement spirituel, enrichie par
                    notre maison d'hôtes qui permet d'offrir un lieu de retraite et de ressourcement à tous ceux qui le
                    souhaitent.
                  </p>
                </div>
              </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-muted-foreground">
                      Cultiver et partager la foi chrétienne dans un esprit d'ouverture et de dialogue, en accompagnant
                      chacun dans son cheminement spirituel personnel.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-8 hover:shadow-lg transition-all duration-300">
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-muted-foreground">
                      Créer des liens fraternels au sein de notre communauté et avec les plus démunis, en mettant
                      l'amour du prochain au cœur de notre action.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-8 hover:shadow-lg transition-all duration-300">
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-muted-foreground">
                      Pratiquer la charité chrétienne par l'accueil, l'écoute et le service, en particulier auprès des
                      personnes en difficulté ou en quête de sens.
                    </p>
                  </div>
                </CardContent>
              </Card>
